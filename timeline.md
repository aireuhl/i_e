...
- template: detail-content
  ...
  content: "<p>In 1778, the Continental Congress signed the first treaty between the
    ...
    hundred years, more than 500 treaties, executive orders and acts of Congress have
    been passed thereby transforming the lived and spatial experience of indigenous
    people within these territories. </p><p>Using the arrows to navigate through the
    timeline, explore the evolution of the visual and geographic representation of
    the North American land mass. Maps are arranged by the year issued and treaties
    ...
    and engraver.</p><p>All map images were originally obtained from the New York
    Public Library's digital collection and are believed to be in the Public Domain.</p>"
- template: detail-content
  block: text-1
